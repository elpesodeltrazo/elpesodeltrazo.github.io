...
const RESENAS = [
  ...
  },
  {
    ...
    te_gustara: 'Si quieres saber más sobre la Revolución islámica de 1979 en Irán. También si te apasionan las historias internsas, conocer conflictos internacional con un maravilloso humor que no nos hace olvidar la gravedad de lo acontecido. ',
    ...
    cuerpo: `<em>Persépolis</em> es una de las grandes obras del comic mundial. La obra es un maravilloso recorrido sobre la Revolución islámica en Irán, a traves de los ojos de Marjane Satrapi. Un relato crudo, pero con cierto humor, que nos presenta el derrocamiento del Sha y la imposición de la dictadura Islámica. <em>Satrapi</em> elige el uso del blanco y negro como arma política para ejemplificar la realidad su pais. No existen colores. Ni siquiera el color gris. O eres parte del sistema, o eres parte del enemigo</p>
    <p>Lo que convierte <em>Persépolis</em> en una obra mayor no es solo el testimonio histórico sino la mirada de la niña que lo cuenta. Satrapi nunca sentencia desde fuera; todo lo vive desde dentro, con la confusión, el humor y las contradicciones dignas de su edad y de su evolución personal.</p>
    <blockquote><p> En la vida, vas a conocer a muchos imbéciles. Si te hacen daño, piensa que es debido a su estupidez. Así evitarás responder a su crueldad. Y es que no hay nada peor en el mundo que el resentimiento y venganza... conserva siempre la dignidad y la integridad.   </p></blockquote>
    <p> Podríamos dividir el comic en tres partes diferenciadas. En una primera, <em>Satrapi</em> muestra su infancia y su percepción en medio de la revolución. En la segunda parte, la protagonista por recomendacion de sus padres, es trasladada a Francia donde estudia sus estudios superiores y se enfrenta sola al reto de aprender a ser mujer. Posteriormente, vuelve a Irán donde encontrará un pais completamente diferente al que ella recordaba cuando era niña.</p> 
